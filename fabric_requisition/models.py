...
# from s.models import StoreReceiver
...
class FabricRequisitionItem(models.Model):
    billno = models.ForeignKey(FabricRequisitionBill, on_delete = models.CASCADE, related_name='ar_billno')
...
class FabricRequisitionBillDetails(models.Model):
    billno = models.ForeignKey(FabricRequisitionBill, on_delete = models.CASCADE, related_name='ar_detailsbillno')
